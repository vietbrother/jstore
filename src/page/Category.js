...
export default class Category extends Component {
  ...
  componentWillMount() {
    var products = [
      {id: 1, title: 'Sashimi', categoryId: 5, categoryTitle: 'Rau củ quả', price: '22$', image: 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQhXMSlJykAZMO8Um0ymIvY-tWMDHLqwrhyb5pSnl7FDWOvkHrQ', description: "Hello there, i'm a cool product with a heart of gold."},
      {id: 2, title: 'Cá hồi', categoryId: 2, categoryTitle: 'Hải sản', price: '12$', image: 'http://103.94.18.249/jstore/wp-content/uploads/2019/04/recipe2-300x188.jpg', description: "Hello there, i'm a cool product with a heart of gold."},
      ...
      {id: 11, title: 'Rong biển', categoryId: 5, categoryTitle: 'Rau củ quả', price: '22$', image: 'http://103.94.18.249/jstore/wp-content/uploads/2019/04/recipe-300x188.jpg', description: "Hello there, i'm a cool product with a heart of gold."},
      {id: 22, title: 'Cá thu', categoryId: 2, categoryTitle: 'Hải sản', price: '12$', image: 'http://103.94.18.249/jstore/wp-content/uploads/2019/04/recipe-300x188.jpg', description: "Hello there, i'm a cool product with a heart of gold."},
