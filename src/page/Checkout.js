...
export default class Checkout extends Component {
        ...
        return (
            <Container style={{backgroundColor: '#fdfdfd'}}>
                ...
                <Content padder>
                    ...
                    {/*<Card>*/}
                    {/*<CardItem header>*/}
                    {/*<Text style={styles.infoHeader}>Thông tin giao hàng</Text>*/}
                    {/*</CardItem>*/}
                    {/*<CardItem>*/}
                    ...
                    {/*/!*<Input placeholder='Country' onChangeText={(text) => this.setState({country: text})} placeholderTextColor="#99b5bb" />*!/*/}
                    {/*/!*</Item>*!/*/}
                    {/*<CardItem>*/}
                    {/*<Input placeholder='Địa chỉ (số nhà/quận/...)'*/}
                    ...
                    {/*</CardItem>*/}
                    {/*/!*<Item regular style={{marginTop: 7}}>*!/*/}
                    {/*/!*<Input placeholder='Mã bưu chính' onChangeText={(text) => this.setState({postcode: text})} placeholderTextColor="#99b5bb" />*!/*/}
                    {/*/!*</Item>*!/*/}
                    {/*<CardItem>*/}
                    ...
                    <View style={styles.boxWithShadow}>
                        ...
                        <View style={styles.invoice}>
                            ...
                            <Item>
                                ...
                                <Text style={styles.require}>* </Text>
                                <Input placeholder='Quận (*)' onChangeText={(text) => this.setState({address: text})}
                                       placeholderTextColor="#99b5bb"/>
                            </Item>
                            <Item>
                    ...
                    <View style={styles.boxWithShadow}>
                        ...
                        <View style={styles.invoice}>
                            ...
                            <Item style={styles.item}>
                                ...
                                <FAIcon name="dollar" size={20} color="#34495e" style={{marginLeft: 7}}/>
                                <Right>
    ...
    renderCheckoutButton() {
        ...
        <TouchableHighlight onPress={() => Actions.login()}>
            <View
                style={{flex: 1, alignItems: 'center', backgroundColor: '#6fafc4', paddingTop: 20, paddingBottom: 20}}>
